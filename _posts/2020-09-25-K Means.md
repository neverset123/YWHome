...
an unsupervised machine learning technique used to identify clusters of data objects in a dataset
...
### speed up k means
#### faiss
a library for fast similarity search and clustering, it can speed up k means clustering using GPU concurrency
